...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .permitAll()
                .antMatchers("/contract/show", "/home").access("hasRole('CLIENT') or hasRole('MANAGER')")
                .antMatchers("/manager/**", "/contract/blocked", "/contract/approved", "/news/add", "/news/delete").access("hasRole('MANAGER')")
                .anyRequest()
                .authenticated()
                .and()
                .formLogin()
