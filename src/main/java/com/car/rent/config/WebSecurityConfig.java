...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/news/**", "/car/**", "/registration", "/", "/forgotPassword", "/login", "/css/**", "/img/**")
                .permitAll()
                .antMatchers("/contract/show", "/home").access("hasRole('CLIENT') or hasRole('MANAGER') or hasRole('ACCOUNTANT')")
                .antMatchers("/manager/**", "/contract/blocked", "/contract/approved", "/news/add", "/news/delete").access("hasRole('MANAGER') or hasRole('ACCOUNTANT')")
                .anyRequest()
                .authenticated()
                .and()
                .formLogin()
